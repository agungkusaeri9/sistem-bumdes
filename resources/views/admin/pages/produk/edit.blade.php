                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.produk.update', $item->id) }}" method="post"
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <select name='jenis_id' id='jenis_id'
                                            ...
                                            @foreach ($data_jenis as $jenis)
                                                <option @selected($jenis->id == $item->jenis_id ?? old('jenis_id')) value='{{ $jenis->id }}'>
                                                    {{ $jenis->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('jenis_id')
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <select name='satuan_id' id='satuan_id'
                                            ...
                                            @foreach ($data_satuan as $satuan)
                                                <option @selected($satuan->id == $item->satuan_id ?? old('satuan_id')) value='{{ $satuan->id }}'>
                                                    {{ $satuan->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('jenis_id')
                                    ...
                                    <div class="form-group">
                                        <button class="btn float-right btn-primary">Simpan Data</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card-body -->
